...
| [`hermes-tweet`](./plugins/hermes-tweet/) | Guides Claude Code users through the native Hermes Agent X/Twitter plugin: install, read-first workflows, and action-gated publishing. |
